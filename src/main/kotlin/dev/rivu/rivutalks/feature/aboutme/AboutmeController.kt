    ...
    suspend fun getAboutMe(): HttpResponse<AboutMeResponse> = handleResponse {
        ...
        Success(
            AboutMeResponse(
                ...
                aboutMeDetails = """Rivu Chakraborty, is an ADHDer (diagnosed) who may be on the Autism (undiagnosed, yet) spectrum as well. He is a community person, an Android & Kotlin developer, one of the early adopters of Kotlin. **India's first GDE (Google Developers Expert) for Kotlin (https://developers.google.com/community/experts/directory/profile/profile-rivu-chakraborty)**.
